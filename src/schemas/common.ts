...
export const CollectionInputSchema = z.object({
  ...
  limit: z.number().int().min(1).max(MAX_GOOGLE_HEALTH_LIMIT).default(DEFAULT_LIMIT),
...
export const CapabilitiesOutputSchema = z.object({
  ...
  auth_model: z.object({ type: z.string(), token_storage: z.string(), recommended_redirect_uri: z.string(), default_scopes: z.array(z.string()), write_scopes: z.array(z.string()).optional() }).strict(),
